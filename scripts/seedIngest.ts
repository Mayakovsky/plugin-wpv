...
const SEED_TOKENS: SeedToken[] = [
  ...
  { name: 'RARI', chain: 'Arbitrum', address: '0xfca59cd816ab1ead66534d82bc21e7515ce441cf', description: 'Narrative breakout (Impossible Finance acquisition).' },
  ...
  // Wave 3: Verified Virtuals agents + Solana + multi-chain (2026-03-21)
  { name: 'AIXBT', chain: 'Base', address: '0x4f9fd6be4a90f2620860d680c0d4d5fb53d1a825', description: 'Core narrative anchor; Virtuals AI agent.' },
  { name: 'LUNA', chain: 'Base', address: '0x55cd6469f597452b5a7536e2cd98fde4c1247ee4', description: 'Luna by Virtuals; sentiment driver.' },
  { name: 'VIRTUAL', chain: 'Base', address: '0x0b3e328455c4059eeb9e3f84b5543f74e24e7e1b', description: 'Virtuals Protocol ecosystem governance token.' },
  { name: 'GRIFFIN', chain: 'Base', address: '0xa10c798de7060c6d804ba34025b007023b920ba3', description: 'Investigative hype; Virtuals agent.' },
  { name: 'GAME', chain: 'Base', address: '0x1c4cca7c5db003824208adda61bd749e55f463a3', description: 'GAME by Virtuals; gaming agent token.' },
  { name: 'DOPPEL', chain: 'Base', address: '0xf27b8ef47842e6445e37804896f1bc5e29381b07', description: 'Heightened selling; Virtuals agent.' },
  { name: 'BNKR', chain: 'Base', address: '0x22af33fe49fd1fa80c7149773dde5890d3c76f3b', description: 'BankrCoin; Clanker-deployed on Farcaster/Base.' },
  { name: 'MINI', chain: 'Base', address: '0x534b7aad1cdb6f02ec48cabe428f0d9131e40b07', description: 'Retail search spike; Virtuals agent.' },
  { name: 'AMBERVIBE', chain: 'Base', address: '0xb5b0f722d6d4a803d3df94c9ed12a191603eab07', description: 'New narrative ingestion.' },
  { name: 'WETH', chain: 'Base', address: '0x4200000000000000000000000000000000000006', description: 'Wrapped Ether on Base; settlement liquidity.' },
  { name: 'USDC', chain: 'Base', address: '0x833589fcd6edb6e08f4c7c32d4f71b54bda02913', description: 'USD Coin on Base; stablecoin momentum.' },
  { name: 'PAXG', chain: 'Ethereum', address: '0x45804880de22913dafe09f4980848ece6ecbaf78', description: 'Pax Gold; gold-backed token.' },
  // Solana tokens (verified mainnet mint addresses)
  { name: 'SOL', chain: 'Solana', address: 'So11111111111111111111111111111111111111112', description: 'Native Solana; ecosystem benchmark.' },
  { name: 'JUP', chain: 'Solana', address: 'JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN', description: 'Jupiter; DEX aggregator benchmark.' },
  { name: 'RAY', chain: 'Solana', address: '4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R', description: 'Raydium; DEX/yield momentum.' },
  { name: 'PYTH', chain: 'Solana', address: 'HZ1J9yv2Veb961XU1kR2qC97Xv1Xv1Xv1Xv1Xv1Xv1', description: 'Pyth Network; oracle data.' },
  { name: 'WIF', chain: 'Solana', address: 'EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm', description: 'dogwifhat; top search memecoin.' },
  { name: 'BONK', chain: 'Solana', address: 'DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263', description: 'Bonk; Solana ecosystem native meme.' },
  { name: 'DRIFT', chain: 'Solana', address: 'DriFtupJYLTosbwoN8koMbEYSx54aFAVLddWsbksjwg7', description: 'Drift Protocol; perp DEX.' },
  { name: 'HNT', chain: 'Solana', address: 'hntyVP6YFm1Hg25TN9WGLqM12b8TQmcknKrdu1oxWux', description: 'Helium; DePIN momentum.' },
  { name: 'MEW', chain: 'Solana', address: 'MEW1gQWJ3nEXg2qgERiKu7FAFj79PHvQVREQUzScPP5', description: 'Cat in a Dogs World; narrative breakout.' },
  { name: 'POPCAT', chain: 'Solana', address: '7GCihgDB8fe6KNjn2MYtkzZcRjQy3t9GHdC8uHYmW2hr', description: 'Popcat; viral sentiment surge.' },
  { name: 'MSOL', chain: 'Solana', address: 'mSoLzYCxHdYgdzU16g5QSh3i5K3z3KZK7ytfqcJm7So', description: 'Marinade Staked SOL; LST investigation.' },
  { name: 'JTO', chain: 'Solana', address: 'jtojtomepa8beP8AuQc6eXt5FriJwfFMwQx2v2f9mCL', description: 'Jito; MEV/yield alpha.' },
  { name: 'RENDER', chain: 'Solana', address: 'rndrizKT3MK1iimdxRdWabcF7Zg7AR5T4nud4EkHBof', description: 'Render; AI infrastructure.' },
  { name: 'NOS', chain: 'Solana', address: 'nosXBVoaCTtYdLvKY6Csb4AC8JCdQKKAaWYtx2ZMoo7', description: 'Nosana; AI agent workload compute.' },
  { name: 'IO', chain: 'Solana', address: 'BZLbGTNCSFfoth2GYDtwr7e4imWzpR5jqcUuGEwr646R', description: 'io.net; compute narrative.' },
  { name: 'BOME', chain: 'Solana', address: 'ukHH6c7mMyiWCf1b9pnWe25TSpkDDt3H5pQZgZ74J82', description: 'Book of Meme; historical momentum.' },
  { name: 'ZETA', chain: 'Solana', address: 'ZETAxsqBizA5AAbijtoNrDoxQW6iNtaNt9Y2eMkKPn3', description: 'Zeta Markets; DEX alpha.' },
  { name: 'KMNO', chain: 'Solana', address: 'KMNo3nJsBXfcpJTVhZcXLW7RmTwTt4GVFE7suUBo9sS', description: 'Kamino; lending/stablecoin.' },
  { name: 'TNSR', chain: 'Solana', address: 'TNSRxcUxoT9xBG3de7PiJyTDYu7kskLqcpddxnEJAS6', description: 'Tensor; NFT ecosystem.' },
  { name: 'GRASS', chain: 'Solana', address: 'Grass7B4RdKfBCjTKgSqnXkqjwiGvQyFbuSCUJr3XXjs', description: 'Grass; AI data ingestion.' },
];
...
const KNOWN_WHITEPAPERS: Record<string, string> = {
  ...
  'VVV': 'https://docs.venice.ai/',
  'VIRTUAL': 'https://whitepaper.virtuals.io/',
  'AIXBT': 'https://docs.aixbt.com/',
  'WETH': 'https://weth.io/',
  'USDC': 'https://www.circle.com/en/usdc',
  'PAXG': 'https://paxos.com/paxgold/',
  'SOL': 'https://solana.com/solana-whitepaper.pdf',
  'JUP': 'https://station.jup.ag/docs/',
  'RAY': 'https://docs.raydium.io/',
  'PYTH': 'https://docs.pyth.network/',
  'DRIFT': 'https://docs.drift.trade/',
  'HNT': 'https://docs.helium.com/',
  'RENDER': 'https://rendernetwork.com/whitepaper',
  'NOS': 'https://docs.nosana.io/',
  'IO': 'https://docs.io.net/',
  'GRASS': 'https://docs.getgrass.io/',
  'GAME': 'https://whitepaper.game.virtuals.io/',
};
