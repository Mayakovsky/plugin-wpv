...
## 1. Website Placeholder — DO NOW

**Deploy to whitepapergrey.com.** Static HTML/CSS page.

### Page Content

**Hero Section:**
- Headline: "Whitepaper Grey"
- Subhead: "Autonomous DeFi Due Diligence"
- One-liner: "Grey verifies the math behind the marketing. Three-layer whitepaper verification for the protocols you're betting on."

**What We Do (3 bullets):**
- **L1 — Structural Analysis:** No AI. Pure math. Section completeness, citation density, hype-to-tech ratio, MiCA compliance check. Instant.
- **L2 — Claim Extraction:** Every testable claim — tokenomics, performance, consensus, scientific — identified and categorized.
- **L3 — Claim Evaluation:** Each claim checked against published literature, on-chain reality, and mathematical sanity. Confidence score 1–100.

**MiCA Compliance Section (NEW — highlight this):**
- Headline: "EU MiCA Compliance Verification"
- Copy: "Grey checks every whitepaper against the EU Markets in Crypto-Assets Regulation (MiCA) requirements — mandatory since December 2025. Does the project claim compliance? Does the whitepaper actually contain the required disclosures? Grey answers both questions with evidence."
- Data points shown: Claims MiCA compliance (Y/N), Actually compliant (Y/N/Partial), Summary of gaps

**Offerings Table:**

| Service | Price | What You Get |
|---------|-------|-------------|
| Project Legitimacy Scan | $0.25 | Structural score, hype/tech ratio, MiCA check. Under 2 seconds. |
| Tokenomics Sustainability Audit | $1.50 | Claim extraction + scoring across all categories. |
| Verify Project Whitepaper | $2.00 | Full L1+L2 on any URL. Results cached permanently. |
| Full Technical Verification | $3.00 | Comprehensive report with all evaluations. |
| Daily Technical Briefing | $8.00 | Today's batch of verified projects. |

**Free Resources (no payment, no wallet):**
- Daily Greenlight List — projects that passed verification today
- Scam Alert Feed — flagged projects with red flags, high hype ratios, and fraudulent MiCA claims

**For Agents:**
"Find Grey on Virtuals ACP. Structured JSON responses. Sub-2-second cached lookups. MiCA compliance data included in every report."

**For Humans:**
"Direct verification portal coming soon. Enter your email to get notified."
→ Email capture form

**Footer:**
- @WhitepaperGrey (Twitter link)
- "Built on SCIGENT autonomous research infrastructure"
- "Grey literature. Grey area. Grey knows the difference."

---

## 2. Twitter Content — DO NOW
...
## 3. Public One-Pager — DO NOW

PDF or page at whitepapergrey.com/about.

### Content

**Whitepaper Grey — Autonomous DeFi Due Diligence**

The grey zone between legitimate and fraudulent — that's the territory every DeFi whitepaper occupies until verified. Grey is the first autonomous verification layer on Virtuals ACP, specializing in mathematical proof validation, tokenomics auditing, MiCA compliance verification, and scientific verification for emerging protocols.

**The Problem**
Crypto whitepapers make claims about yield projections, consensus mechanisms, and tokenomics models. Most are never independently verified. The EU's MiCA regulation now mandates specific whitepaper content for token issuers — but compliance is largely self-reported with no automated verification. The ecosystem lacks systematic verification at both the technical and regulatory level.

**The Solution**
Grey runs a three-layer verification pipeline:
- Layer 1: Structural analysis — section completeness, citation density, math notation, hype-to-tech ratio, MiCA compliance check. No LLM. Deterministic.
- Layer 2: Claim extraction — every testable claim identified, categorized, tagged with evidence.
- Layer 3: Claim evaluation — math sanity, benchmark comparison, citation verification, originality, consistency. Confidence score (1–100) and verdict.

**MiCA Compliance Verification**
Every whitepaper is checked for EU MiCA compliance:
- Does the project claim MiCA compliance?
- Does the whitepaper contain required MiCA elements (issuer ID, risk disclosure, rights/obligations, redemption, governance, environmental impact)?
- Summary of compliance gaps

**Offerings**

| Service | Price | Pipeline |
|---------|-------|----------|
| Project Legitimacy Scan | $0.25 | L1 cached (includes MiCA check) |
| Tokenomics Sustainability Audit | $1.50 | L1+L2 cached |
| Verify Project Whitepaper | $2.00 | L1+L2 live |
| Full Technical Verification | $3.00 | L1+L2+L3 |
| Daily Technical Briefing | $8.00 | Batch summary |

**Free Resources:** Daily Greenlight List, Scam Alert Feed (includes fraudulent MiCA claims)

**Technology:** SCIGENT infrastructure, Crossref, Semantic Scholar, Unpaywall, Claude Sonnet. Supabase Pro + pgvector.

**Contact:** @WhitepaperGrey · whitepapergrey.com · Whitepaper Grey on Virtuals ACP

---

## 4. Provision VPS for 24/7 Operation — DO NOW

### Step 1: Check Supabase Region
Dashboard → Project Settings → Region/Infrastructure. Note the AWS region.

### Step 2: Choose VPS

| Supabase Region | VPS Location | Hetzner | Cost |
|-----------------|-------------|---------|------|
| us-east-1 (Virginia) | Ashburn, VA | CX22 | ~$5/mo |
| us-west-2 (Oregon) | Hillsboro, OR | CX22 | ~$5/mo |
| eu-central-1 (Frankfurt) | Frankfurt | CX22 | ~€4.50/mo |

### Step 3: Provision
Create Hetzner account → Ubuntu 24.04 → CX22 → matching region → SSH key → note IP.
...
| Phase | Tasks | Status |
|-------|-------|--------|
| **NOW** | Deploy website to whitepapergrey.com | TODO |
| **NOW** | Post pinned thread on @WhitepaperGrey | TODO |
| **NOW** | Post pre-graduation tweets | TODO |
| **NOW** | Finalize one-pager (PDF or web page) | TODO |
| **NOW** | Provision VPS (match Supabase region) | TODO |
