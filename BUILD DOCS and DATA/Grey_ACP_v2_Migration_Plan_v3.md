# ACP v2 SDK Migration Plan — Whitepaper Grey (v3)

> **Source:** Forces v1 → Kovsky v1 review → Forces v2 → Kovsky v2 thorough review → Kovsky v3 rewrite
> **Date:** 2026-04-11
...
| Get active jobs | `acpClient.getActiveJobs(page, size)` | `agent.getApi().getActiveJobs()` |
...
// getActiveJobs — v2 uses agent.getApi()
